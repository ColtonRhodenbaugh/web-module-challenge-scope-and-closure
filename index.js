...
/*Task 1: counterMaker()
  ...
  Counter 1 will remember each time it is ran the other will not
  2. Which of the two uses a closure? How can you tell?
  the first one because of the return function counter()
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  Counter 1 would be useful if you wanted the code to remeber, code 2 would be
     useful for the opposit reason
*/
